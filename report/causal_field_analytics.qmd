...
|---|---:|---:|---|
| Naive comparison | +7.11% relative failure increase | n/a | Wrong direction due to confounding |
...
| Synthetic control | +10.50 pp gap | n/a | Rejected due to poor pre-fit |
| Cox PH | HR = 0.812 | [0.718, 0.918] | Main reliability estimate |
| Ground truth | HR = 0.850 | n/a | Known simulation target |
